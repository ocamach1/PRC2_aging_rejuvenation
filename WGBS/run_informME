...
# Running the informME pipeline consists of 4 steps:
...
# 'BAM_file' is the name of the WGBS BAM file sorted by coordinates, obtained from align_process_WGBS.sh.
# 'chr_number' is the chromosome number. The function should be ran for each chromosome.
getMatrices.sh -c 1 -t "$trim" "$BAM_file" "$chr_number"

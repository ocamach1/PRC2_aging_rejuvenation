...
# The BED files with JSD information from relevant comparisons (generated in step 4.2) will be used to rank genes based on JSD and mutual information 
# (source code included in JSD_ranking_source_code.R). The specific BED files generated by step 4.2, included in our study and used for statistical testing, are specified in 
# JSD_ranking_comparisons.R
